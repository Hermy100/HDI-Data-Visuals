...
country_colors <- c("China" = "#334680", "India" = "#674a8f", "United Arab Emirates" = "#984992",
                    "Egypt" = "#c54888", "Iran (Islamic Republic of)" = "#e94775", "Brazil" = "#ff655a",
                    "South Africa" = "#ff8239", "Russian Federation" = "#ffa600")
